export interface ElrondStatus{
    details: {
        ...
        erd_average_block_tx_count: string,
        erd_chain_id: string,
        erd_connected_nodes: number,
        erd_consensus_group_size:  number,
        erd_consensus_processed_proposed_block:  number,
        erd_consensus_received_proposed_block:  number,
        ...
        erd_denomination_coefficient: string,
        ...
        erd_last_block_tx_count: number,
        erd_latest_tag_software_version: string,
        erd_leader_percentage: string,
